    ...
    <div className="flex-1 flex flex-col h-0 relative">
      <div className="flex-1 h-0 w-full flex flex-col">
        <Loader loading={loading}>
          <div
            ...
            className="w-full flex-1 h-0 flex flex-col gap-3 pl-5 py-5 chat-window overflow-y-auto bg-slate-200"
          >
            {chats.length ? (
              chats.map((chat) => (
                <Bubble
      ...
      >
        <div className="flex justify-between">
          ...
          <Button
            type="submit"
            className="mt-3 px-7 bg-gradient-to-br from-[#20aff1] to-[#2395ff]"
            disabled={!chatRoom}
          >
            Send
          </Button>
